...
### Fixed
- **Sync status indicator**: Yellow "remote update available" dot now correctly turns green after a successful sync completes
...
- **Local repo skill discovery**: Newly-added skills in local repositories now appear immediately on page refresh without requiring a manual sync
